...
This module will auto import anything in the redbox.processors.* path, so long as the following rules are met:
...
# Dynamically load Processors from redbox/processors/*Processor.py
for dirpath, dirnames, filenames in os.walk(os.path.dirname(__file__)):
    for filename in filenames:
        ...
        and filename != "BaseProcessor.py":
            ...
            module = importlib.import_module(f'redbox.processors.{modulename}')
